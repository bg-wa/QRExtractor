        ...
        setTimeout(function(){
          $.each(qr_chunks, function(i, chunk){
            setTimeout(function(){
              ...
              $('#qr_codes').append('<div id="' + qr_obj_id + '" style="margin:10px; max-width: 100px; display: inline-block">'+i+'</div>');
              $('#' + qr_obj_id).qrcode({render: 'canvas', size: 100, text: chunk});
